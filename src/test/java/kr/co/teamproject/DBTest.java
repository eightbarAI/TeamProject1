...
public class DBTest {
	...
	@Test
	public void connectionTest() { // 여기서 excepcion이 발생하면 //DataSource의 property 이름 문제나 //driverClassName(MySQL 의존성
									// // 설정 문제 포함) 문제
	 ...
	 * 
	 * @Test public void mybatisTest() { System.out.println("MyBatis 객체 :" +
	 * sqlSession); }
	 */
